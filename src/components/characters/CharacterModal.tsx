  ...
  return (
    ...
    >
      {isFetching ? (
        ...
        <div className="w-3/4 md:w-1/2 h-auto md:h-2/5 flex flex-col md:flex-row bg-gray-200 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg shadow-lg">
